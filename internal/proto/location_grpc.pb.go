...
type LocationDataServiceClient interface {
	...
	FindEventIdsWithin(ctx context.Context, in *LocationQueryObject, opts ...grpc.CallOption) (*EventIds, error)
}
...
func (c *locationDataServiceClient) FindEventIdsWithin(ctx context.Context, in *LocationQueryObject, opts ...grpc.CallOption) (*EventIds, error) {
	out := new(EventIds)
	err := c.cc.Invoke(ctx, "/proto.LocationDataService/FindEventIdsWithin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocationDataServiceServer interface {
	...
	FindEventIdsWithin(context.Context, *LocationQueryObject) (*EventIds, error)
...
func (UnimplementedLocationDataServiceServer) FindEventIdsWithin(context.Context, *LocationQueryObject) (*EventIds, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindEventIdsWithin not implemented")
}
...
func _LocationDataService_FindEventIdsWithin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LocationQueryObject)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationDataServiceServer).FindEventIdsWithin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.LocationDataService/FindEventIdsWithin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationDataServiceServer).FindEventIdsWithin(ctx, req.(*LocationQueryObject))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LocationDataService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindEventIdsWithin",
			Handler:    _LocationDataService_FindEventIdsWithin_Handler,
		},
	},
